...
export TRAIN_DATA_PATH=/inspire/hdd/project/moe-speedup/public/datasets/gsm8k/train.parquet
export TEST_DATA_PATH=/inspire/hdd/project/moe-speedup/public/datasets/gsm8k/test.parquet
#export TRAIN_DATA_PATH=/inspire/hdd/global_user/wanrui-p-wanrui/data/gsm8k/train.parquet
#export TEST_DATA_PATH=/inspire/hdd/global_user/wanrui-p-wanrui/data/gsm8k/test.parquet
export MODEL_PATH=/inspire/hdd/project/moe-speedup/public/models/Qwen3-30B-A3B

export GLOO_SOCKET_IFNAME=bond0
export NCCL_IB_GID_INDEX="3"

# Base output paths
export BASE_CKPT_PATH=/inspire/hdd/global_user/huxiaohe-p-huxiaohe/zhangmj
...
export PPO_MICRO_BATCH_SIZE_PER_GPU=2   #not 2/4
export LP_MICRO_BATCH_SIZE_PER_GPU=4
export MAX_PROMPT_LENGTH=2048
export MAX_RESPONSE_LENGTH=4096
export ROLLOUT_GPU_MEMORY_UTILIZATION=0.75
export ROLLOUT_TP=8
export ROLLOUT_N=16
export SAVE_FREQ=-1
export TEST_FREQ=10
...
export PROJECT_NAME=siirl_zhanngmj_deepep_megatron_${DATASET}_${ALG}
export EXPERIMENT_NAME=${MODEL_NAME}_gentp${ROLLOUT_TP}_tp${ACTOR_REF_TP}pp${ACTOR_REF_PP}ep${ACTOR_REF_EP}_$(date +%Y%m%d_%H%M%S)_${TRAIN_BATCH_SIZE_PER_NODE}_${PPO_MINI_BATCH_SIZE_PER_NODE}_${NNODES}nodes
...
TRAINING_CMD=(
    ...
    actor_rollout_ref.rollout.log_prob_micro_batch_size_per_gpu=\$LP_MICRO_BATCH_SIZE_PER_GPU \
    ...
    actor_rollout_ref.ref.log_prob_micro_batch_size_per_gpu=\$LP_MICRO_BATCH_SIZE_PER_GPU \
...
start_ray_cluster() {
    local RAY_HEAD_WAIT_TIMEOUT=1200
    ...
    export RAY_GCS_RPC_CLIENT_CONNECT_TIMEOUT_S=1200
...
main() {
    ...
    export GLOO_SOCKET_TIMEOUT=1800
    export GLOO_TCP_TIMEOUT=1800
